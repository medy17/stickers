...
class _MultiCropPageState extends State<MultiCropPage> {
  ...
  Future<void> _crop(_Selection selection) async {
    ...
    try {
      final result = await Navigator.of(context).push<Uint8List>(MaterialPageRoute(
        builder: (_) => CropPage(
          pack: widget.pack,
          index: 0,
                          ...
                          children: [
                                  ...
                                  child: Stack(fit: StackFit.expand, children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: IconButton.filledTonal(
                                        ...
                                        onPressed: busy ? null : () => setState(() => _selections.remove(selection)),
                            ...
                            if (selection.error != null)
                              Tooltip(
                                ...
                                child: Text(l10n.couldntLoadMedia,
